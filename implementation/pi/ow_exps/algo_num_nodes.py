...
dir_names = ['consistent_hashing_logs', 'baseline_logs', 'greedy_logs', 'weighted_dist_logs']
# dir_names = ['greedy_logs', 'baseline_logs', 'consistent_hashing_logs']
translate = {
...
if __name__ == "__main__":
    ...
    plt.savefig('./cold_warm_starts/alg_cold_warm_starts_combined.png')