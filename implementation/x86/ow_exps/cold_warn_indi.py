...
dir_names = ['baseline_logs']
translate = {
    'baseline_logs': 'weighted_dist'
}
...
if __name__ == '__main__':
    ...
    for alg in consol_alg_counts.keys():
        ...
        plt.bar(np.arange(0, tot_algos), warm_starts, color='blue', width=0.2)
        plt.bar(np.arange(0, tot_algos) + 0.2, prewarm_starts, color='green', width=0.2)

    plt.xlabel('Policies')
    plt.xticks(np.arange(0, tot_algos), ['baseline'])
